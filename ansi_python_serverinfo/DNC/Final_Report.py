...
def merge_rows(input_file):
    ...
    # Save the modified HTML to a new file (final.html)
    output_file = 'final.html'
    with open(output_file, 'w') as file:
        file.write(str(soup))

    print(f"HTML file with merged rows generated: {output_file}")

# Test the function with prefinal.html
input_file = 'prefinal.html'
